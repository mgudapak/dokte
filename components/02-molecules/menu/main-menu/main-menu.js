      ...
      Array.from(expandMenu).forEach((item) => {
        item.addEventListener('click', (e) => {
          ...
          if (menuItem.classList.contains('expand-sub--open')) {
            menuItem.classList.remove('fa-chevron-right');
            menuItem.classList.add('fa-chevron-down');
          } else {
            menuItem.classList.add('fa-chevron-right');
            menuItem.classList.remove('fa-chevron-down');
          }
        });
      });
    }
